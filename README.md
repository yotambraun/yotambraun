...
- [**VisualInsight**](https://github.com/yotambraun/VisualInsight): An app leveraging **Google Generative AI (Gemini)** to analyze images. This Streamlit-based web application allows users to upload images for analysis, storing both the original images and results in **Amazon S3**.[Read the article on Medium](hhttps://medium.com/@yotambraun/visualinsight-an-end-to-end-image-analysis-application-using-google-generative-ai-gemini-7847f6f0a1b9).
