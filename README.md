...
- [**Toolscore: LLM Tool-Calling Evaluation Framework**](https://github.com/yotambraun/Toolscore): A Python testing framework that evaluates how well **Large Language Models** perform when making tool calls. It analyzes agent execution traces, provides comprehensive metrics including invocation accuracy, argument matching, and parameter validation, with support for **OpenAI**, **Anthropic**, **Google Gemini**, and **MCP**. With over **6,000 downloads**, it includes interactive debugging, HTML/JSON reporting, and Pytest plugin integration for CI/CD pipelines.
